...
LOCAL_CFLAGS += -DRECOVERY_VERSION="Safestrap Recovery 1.05"
RECOVERY_API_VERSION := 2
LOCAL_CFLAGS += -DRECOVERY_API_VERSION=$(RECOVERY_API_VERSION)
RECOVERY_FOLDER := safestrap
LOCAL_CFLAGS += -DRECOVERY_FOLDER="$(RECOVERY_FOLDER)"

BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_HAS_SMALL_RECOVERY BOARD_LDPI_RECOVERY BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_NONSAFE_SYSTEM_DEVICE BOARD_HAS_SDEXT BOARD_HAS_WEBTOP BOARD_HAS_SDCARD_INTERNAL BOARD_HAS_LOCKED_BOOTLOADER
