...
BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_HAS_SMALL_RECOVERY BOARD_LDPI_RECOVERY BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_NONSAFE_SYSTEM_DEVICE BOARD_HAS_SDEXT BOARD_HAS_SDCARD_INTERNAL BOARD_HAS_LOCKED_BOOTLOADER OPEN_RECOVERY_HAVE_CONSOLE

#ifdef BOARD_HAS_HARD_KEYBOARD
LOCAL_CFLAGS += -DOPEN_RECOVERY_HAVE_CONSOLE=true
#endif
